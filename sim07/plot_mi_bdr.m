...
%%
snr = 10:3:40;
plot(snr, mi_bit_1128,'k-o','LineWidth',1.5);
hold on;
...
hold on;
plot(snr, mi_bit_1128_guard_n(:,1:11),'--*','LineWidth',1.5, 'Color', '#0072BD');
grid on;
...
plot(snr, bdr_1128,'k-o','LineWidth',1.5);
hold on;
plot(snr, bdr_3128,'k--x','LineWidth',1.5);
hold on;
plot(snr, bdr_1256,'r-d','LineWidth',1.5);
hold on;
plot(snr, bdr_3256,'r--s','LineWidth',1.5);
hold on;
plot(snr, bdr_1128_guard,'b-^','LineWidth',1.5);
hold on;
plot(snr, bdr_1256_guard,'b--v','LineWidth',1.5);
hold on;
plot(snr, bdr_1128_guard_n,'--*','LineWidth',1.5, 'Color', '#0072BD');
grid on;
axis([10 40 0.0 0.09]);
legend('K = 1, N_{FFT} = 128','K = 3, N_{FFT} = 128','K = 1, N_{FFT} = 256','K = 3, N_{FFT} = 256','K = 1, N_{Guard} = 128','K = 1, N_{Guard} = 256','K = 1, N_{Guard}= 128,Noiseless');
