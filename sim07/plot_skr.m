...
ve1_trad_3 = ve1;
ve2_trad_3 = ve2;
mi_trad_bit_3 = mi_bit;
cmi_trad_ve2_3 = cmi_ve2;
cmi_trad_ve1_3 = cmi_ve1;
...
%%
% plot(snr,mi_bit_0,'y-+','LineWidth',1.5);
% hold on;
% plot(snr,mi_bit_3,'y-+','LineWidth',1.5);
% hold on;
% plot(snr,mi_bit_6,'y-+','LineWidth',1.5);
% hold on;
plot(snr,cmi_ve2_0,'r-o','LineWidth',1.5);   %%第一类窃听方法后的安全速率
hold on;
plot(snr,cmi_ve1_0,'b-v','LineWidth',1.5);
plot(snr,cmi_trad_ve2_0,'k-d','LineWidth',1.5);
% plot(snr,cmi_ve2_3,'r-^','LineWidth',1.5);
% plot(snr,cmi_ve1_3,'r--v','LineWidth',1.5);
plot(snr,cmi_ve2_6,'r--o','LineWidth',1.5);
plot(snr,cmi_ve1_6,'b--v','LineWidth',1.5);
plot(snr,cmi_trad_ve2_6,'k--d','LineWidth',1.5);
hold off;
grid on;
axis([10 40 0 0.9])
legend('cor = 0, V|ve^1','cor = 0, V|ve^2','cor = 0, h12|ve^1','cor = 0.6, V|ve^1','cor = 0.6, V|ve^2','cor = 0.6, h12|ve^1');
ylabel('Secret Key Rate (bit)');
xlabel('SNR (dB)');

plot(snr,mi_bit_0-cmi_ve2_0,'r-o','LineWidth',1.5);
hold on;
plot(snr,mi_bit_0-cmi_ve1_0,'b-v','LineWidth',1.5);
plot(snr,mi_bit_0- cmi_trad_ve2_0,'k-d','LineWidth',1.5);
% plot(snr,mi_bit_3-cmi_ve2_3,'r-^','LineWidth',1.5);
% plot(snr,mi_bit_3-cmi_ve1_3,'r--v','LineWidth',1.5);
plot(snr,mi_bit_6-cmi_ve2_6,'r--o','LineWidth',1.5);
plot(snr,mi_bit_6-cmi_ve1_6,'b--v','LineWidth',1.5);
plot(snr,mi_bit_6- cmi_trad_ve2_6,'k--d','LineWidth',1.5);
grid on;
axis([10 40 0 0.7])
legend('cor = 0, ve^1','cor = 0, ve^2','cor = 0, ve^1(h12)','cor = 0.6, ve^1','cor = 0.6, ve^2','cor = 0.6, ve^1(h12)');
