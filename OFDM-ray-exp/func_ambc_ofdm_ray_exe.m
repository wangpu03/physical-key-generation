...
function [v12,v21,x_bd1,x_bd2] = func_ambc_ofdm_ray_exe(pt)
...
h_f2=(randn(1,1)+i*randn(1,1)).*sqrt(pow_f2/2);
...
h_h12=(randn(1,1)+i*randn(1,1)).*sqrt(pow_h12/2);
h_h21 = h_h12;
...
x_bd1 = x_s_noise_bd1_pwr;
x_bd2 = x_s_noise_bd2_pwr;
